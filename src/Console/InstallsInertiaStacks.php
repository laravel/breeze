...
trait InstallsInertiaStacks
{
     ...
     * @return int|null
     */
    protected function installInertiaVueTypescriptStack()
    {
        // Install Inertia...
        if (! $this->requireComposerPackages(['inertiajs/inertia-laravel:^0.6.8', 'laravel/sanctum:^3.2', 'tightenco/ziggy:^1.0'])) {
            return 1;
     ...
     * @return void
     */
    protected function installInertiaVueSsrTypescriptStack()
    {
        $this->updateNodePackages(function ($packages) {
            return [
                '@vue/server-renderer' => '^3.2.31',
     ...
     * @return int|null
     */
    protected function installInertiaReactTypescriptStack()
    {
        // Install Inertia...
        if (! $this->requireComposerPackages(['inertiajs/inertia-laravel:^0.6.3', 'laravel/sanctum:^3.2', 'tightenco/ziggy:^1.0'])) {
            return 1;
