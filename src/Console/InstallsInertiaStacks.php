...
trait InstallsInertiaStacks
{
    ...
    {
        // Install Inertia...
        if (! $this->requireComposerPackages('inertiajs/inertia-laravel:^0.6.6', 'laravel/sanctum:^3.2', 'tightenco/ziggy:^1.0')) {
            return 1;
        }
    ...
    protected function installInertiaVueSsrStack()
    {
        ...
        $this->replaceInFile('});', '    ssr: {'.PHP_EOL."        noExternal: ['@inertiajs/vue3/server'],".PHP_EOL.'    },'.PHP_EOL.'});', base_path('vite.config.js'));
    ...
    protected function installInertiaReactSsrStack()
    {
        ...
        $this->replaceInFile('});', '    ssr: {'.PHP_EOL."        noExternal: ['@inertiajs/react/server'],".PHP_EOL.'    },'.PHP_EOL.'});', base_path('vite.config.js'));
