            ...
            <div className="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div className="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <svg
                        ...
                        className="w-auto h-16 text-gray-700 sm:h-20"
                    >
                ...
                <div className="flex justify-center mt-4 sm:items-center sm:justify-between">
                    <div className="text-sm text-center text-gray-500 sm:text-left">
                        <div className="flex items-center">
                            ...
                            <svg
                                ...
                                strokeWidth="2"
                                viewBox="0 0 24 24"
                                className="w-5 h-5 ml-4 -mt-px text-gray-400"
                            >
                    ...
                    <div className="ml-4 text-sm text-center text-gray-500 sm:text-right sm:ml-0">
